...
```bash
curl -X POST https://gateway.pipeworx.io/v1/tools/solana_wallet_tokens \
  -H 'Content-Type: application/json' \
  -d '{"wallet":"Gf9XgdmvNHt8fUTFsWAccNbKeyDXsgJyZN8iFJKg5Pbd","limit":10}'
```

No account needed for the first calls. Inspect any tool: `GET https://gateway.pipeworx.io/v1/tools/solana_wallet_tokens`. Find one: `POST https://gateway.pipeworx.io/v1/tools/search_packs` with `{"query":"..."}`.
